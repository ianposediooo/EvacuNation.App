...
import static com.example.evacunation.R.drawable.check;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Sub ="Download the Latest Version of EvacuNation.apk\n\nEvacuNation - An Evacuation Center Locator and Disaster Preparedness Mobile App\n" + "\nhttps://drive.google.com/file/d/1vPjfnxIw_earvkjnuJKxW7eeN6CfqBwy/view?usp=sharing\n\nShared via EvacuNation\n- Version " + myVersionName;
